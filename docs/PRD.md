...
| P0 (MVP) | FastAPI Container + Python Helper (hassil) | 1.2 | Planned |
| P0 (MVP) | HA-First Chat-Handler mit Intent-Routing | 1.2 | Planned |
| P0 (MVP) | HA Auto-Sync via MQTT | 1.2 | Planned |
