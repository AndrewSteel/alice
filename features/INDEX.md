...
| PROJ-65 | 3.2   | Backend Effective-Permissions API — 3 neue system_permissions-Flags (DMS-Ordner/Chatarchiv/Mailbox-Verwaltung), neuer `GET /api/auth/permissions`-Endpunkt                                                              | Approved | [Spec](PROJ-65-backend-effective-permissions-api.md) | 2026-07-19 |
