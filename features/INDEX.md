...
| PROJ-63 | 3.2   | Backend Sprachcode-Offenheit — alice-auth-Validierung + alice-chat-stream-LLM-Prompt-Logik auf konfigurierbare ISO-639-1-Codes umgestellt statt hartcodiert deutsch/englisch; neuer `GET /api/auth/languages`            | Approved | [Spec](PROJ-63-backend-language-code-extensibility.md) | 2026-07-19 |
